...
class BookwormImgAdapter(val parentView:View,val context:Context) : ListAdapter<BookwormData,RecyclerView.ViewHolder>(MyDiffCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        when(viewType){
            1->{
                ...
                selectedView = inflater.inflate(R.layout.fragment_bw_item_selected,parent,false)
